...
DockPetWin Aemeath 是一个桌面陪伴应用，当前发布包以 Windows 主版本为准，macOS 目录仅保留后续适配占位。爱弥斯会在桌面边缘休息、散步、回应提醒、和你聊天，也会在小屋里按行事历生活。
...
| 在桌面边缘休息、散步、被拖动，也会用气泡回应提醒。 | 小屋会保留行事历，关闭窗口后后台仍会推进计划。 | 读书、写小纸条、喝茶、睡觉、游戏、做饭、灶台和沙发玩偶等素材可以持续扩展。 |
